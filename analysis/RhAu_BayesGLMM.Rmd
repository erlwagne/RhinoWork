...
knitr::opts_chunk$set(tidy = FALSE, highlight = TRUE, comment = NA, echo = TRUE,
                      dev = "png", dev.args = list(type = "cairo-png"), dpi = 300, out.width = "75%", fig.align = "center")
...
```{r env_corrplot, fig.height = 7, fig.width = 7, echo = FALSE}
...
```
```{r PCA_plots, fig.height = 7, fig.width = 7, echo = FALSE}
par(mfcol = c(2,2))
# scree plot
...
```{r env_timeseries_plots, fig.height = 10, fig.width = 5, out.width = "50%", echo = FALSE}
...
```{r plot_ppd_occ, fig.width = 4, fig.height = 4, out.width = "40%", echo = FALSE}
...
```{r occ_fitted_timeseries, fig.width = 7, height = 7, echo = FALSE}
...
```{r plot_ppd_suc, fig.width = 4, fig.height = 4, out.width = "40%", echo = FALSE}
## Model validation by graphical posterior predictive checking
# default plot: marginal distribution of data and posterior predictive distribution
pp_check(suc3)
```
...
```{r suc_fitted_timeseries, fig.width = 7, height = 7, echo = FALSE}
## Time series of fitted and observed fledging success at DI and PI
## (This will take some time to render. For alternate version, 
## comment out both calls to densregion() and uncomment polygon()).
par(mar = c(5.1,4.5,1,1))
