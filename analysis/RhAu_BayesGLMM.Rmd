...
nest_data %>% head() %>% kable() #%>% kableExtra::kable_styling(bootstrap_options = c("striped","hover"))
```

And here are the environmental covariates (describe oceanographic indicators)...

```{r show_env, echo = FALSE}
env_data %>% kable(digits = 2) #%>% kableExtra::kable_styling(bootstrap_options = c("striped","hover"))
```
