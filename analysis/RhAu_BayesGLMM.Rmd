...
```{r plot_ppd_occ, fig.dim = c(4,4), out.width = "40%", echo = FALSE}
...
```{r occ_fitted_timeseries, fig.align = "center", fig.dim = c(7,5), out.width = "60%", echo = FALSE}
...
```{r plot_ppd_suc, fig.dim = c(4,4), out.width = "40%", echo = FALSE}
## Model validation by graphical posterior predictive checking
# default plot: marginal distribution of data and posterior predictive distribution
pp_check(suc3)
```
