...
# Monthly 2009-2018
sst_DI <- read.csv(here::here("data","SST_DI_2002_2019.csv"), skip = 8, na.strings = "-32767")[,1:2]
...
sst_PI <- read.csv(here::here("data","SST_PI_2002_2019.csv"), skip = 8, na.strings = "-32767")[,1:2]
...
sst_amph <- read.csv(here::here("data",grep("Amphitrite", list.files(here::here("data")), value = TRUE)),
...
sst_race <- read.csv(here::here("data",grep("Race_Rocks", list.files(here::here("data")), value = TRUE)),
                     skip = 1, na.strings = "99.99")
